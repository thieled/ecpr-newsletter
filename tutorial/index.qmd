...
![Summarizing a document.](https://thieled.github.io/ecpr-newsletter/tutorial/img/03-summarize-doc.gif)
...
1. **Welcome** & **Table of contents** (automatically created) 
2. Main **News** items  
...
For a more comprehensive guide, see [here](https://quarto.org/docs/authoring/markdown-basics.html).
...
All images included in the newsletter must publicly available, hosted on a web server. Use the **previously uploaded** (and cropped images) and find the correct URL. 

The correct URL is always the **base URL**:

`https://thieled.github.io/ecpr-newsletter/` 

plus the relative/path/from/ecpr-newsletter, e.g.: 
...
The items in the **Call for Paper** and **Job Bulletin** section are both formatted by a section called 'job'.
You can edit or remove `**Title**`, `**Location**` etc. as you wish:
...
![Editing a .qmd.](https://thieled.github.io/ecpr-newsletter/tutorial/img/04-edit-qmd.gif)


## 06 · Render the Newsletter to HTML

This step is crucial: it converts the newsletter from .qmd into email-safe **HTML** and inlines **CSS** (style guides) for compatibility with E-Mail programs like Outlook.
...
`issues/2025/12/newsletter_2025_12.html`

Add the base URL:

`https://thieled.github.io/ecpr-newsletter/issues/2025/12/newsletter_2025_12.html`

[Open the URL](https://thieled.github.io/ecpr-newsletter/issues/2025/12/newsletter_2025_12.html) in your browser to **preview**.
